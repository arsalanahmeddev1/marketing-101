...
<body>
    ...
    <main>
        <div class="container m-container">
            <div class="row pt-30">
                <div class="col-md-12">
                    <h3 class="f-arial f-700 f-24">Prohibited</h3>
                    <p class="f-arial text-black f-600">Users must comply with all applicable laws, the Marketing 101
                        terms of
                        use, and all
                        posted site rules.</p>
                    <p class="f-arial text-black">Here is a partial list of goods, services, and content prohibited on
                        craigslist:</p>
                    <ul class="details-list ps-5">
                        ...
                        <li>offers, solicitation, or facilitation of illegal prostitution&nbsp;and/or sex trafficking
                        </li>
                        <li>exploitation or endangerment of minors; child pornography</li>
                        <li>recalled items; hazardous materials;
                            body parts/fluids; unsanitized bedding/clothing</li>
                    ...
                    <p class="f-arial text-black mt-3">Please don't use CL for these purposes, and flag anyone else you
                        see
                        doing so.</p>
                    <p class="f-arial text-black">Thanks for helping keep craigslist safe and useful for everyone.</p>
                </div>
            </div>
        </div>
    </main>
